              ...
              <div className="relative overflow-hidden rounded-[1.75rem] border border-slate-200 bg-slate-950 p-4 text-white shadow-2xl shadow-blue-950/20 sm:p-6 lg:p-7 dark:border-white/10">
                    ...
                    {[
                      ...
                      >
                        <span className="inline-flex max-w-full items-center gap-2 text-[11px] text-slate-400 sm:text-xs">
                          <span
                            className={`size-2 shrink-0 rounded-full ${String(
                              color,
                            )}`}
                          />
                ...
                <div className="mt-5 rounded-2xl border border-white/10 bg-white/5 p-4 sm:mt-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-400">
                    Pengguna pembaca layar dapat kesulitan memahami informasi
                    yang harus diisi.
                  </p>
          ...
          <div className="mx-auto w-full max-w-[1320px] px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="mt-4 text-base leading-7 text-slate-600 dark:text-slate-400">
                Fokus utamanya adalah membantu Anda memahami masalah dan
        ...
        >
          <div className="mx-auto grid w-full max-w-[1320px] gap-10 px-4 sm:px-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:items-center lg:gap-16 lg:px-8">
            <div className="lg:max-w-[560px]">
              ...
              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:mt-5 dark:text-slate-300">
